...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="hayautikun",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10hayautikun11AppDelegate")
...
SWIFT_CLASS("_TtC10hayautikun11AudioPlayer")
...
SWIFT_CLASS("_TtC10hayautikun24PlayDetailViewController")
...
@interface PlayViewController (SWIFT_EXTENSION(hayautikun)) <AVAudioPlayerDelegate>
@end

@class UIButton;

SWIFT_CLASS("_TtC10hayautikun20ResultViewController")
@interface ResultViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified ansnumber;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified homebutton;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified mouitibutton;
- (void)viewDidLoad;
- (IBAction)gohomebutton:(id _Nonnull)sender;
- (IBAction)gomouitibutton:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10hayautikun13SceneDelegate")
...
SWIFT_CLASS("_TtC10hayautikun6Speech")
...
SWIFT_CLASS("_TtC10hayautikun14ViewController")
